...
inline void calculate_block_size(const std::vector<SimilarityChunk> &similarity_chunks, const FSSTCompressionResult &prefix_compression_result, const FSSTCompressionResult &suffix_compression_result, BlockMetadata& b, const size_t suffix_area_start_index) {
