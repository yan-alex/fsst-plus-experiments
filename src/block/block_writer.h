...
void write_block_header(const BlockMetadata b, uint8_t *&current_data_ptr) {
...
void write_prefix_area(FSSTCompressionResult prefix_compression_result, const BlockMetadata b, size_t prefix_area_start_index, uint8_t *&current_data_ptr) {
...
void write_suffix_area(FSSTCompressionResult suffix_compression_result, const BlockMetadata b, size_t suffix_area_start_index, uint8_t *&current_data_ptr) {
	for (size_t i = 0; i < b.suffix_n_in_block; i ++){
...
inline void write_block(FSSTPlusCompressionResult compression_result, FSSTCompressionResult prefix_compression_result, FSSTCompressionResult suffix_compression_result, const BlockMetadata b, size_t suffix_area_start_index, size_t prefix_area_start_index) {
